      ...
      <div className="content-wrapper">
        <div className="left-section">
          <div className="polaroid">
            <img src="https://png.pngtree.com/png-clipart/20231004/original/pngtree-light-blue-ribbon-png-image_13117816.png" alt="Bow" className="floating-bow" style={{ width: "150px", height: "auto" }} />
